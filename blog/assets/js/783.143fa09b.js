...
;// CONCATENATED MODULE: ./node_modules/mermaid/dist/sankeyDiagram-4c46435e.js
...
const findOrCreateNode = (ID) => {
  ID = mermaid_59c9be08.e.sanitizeText(ID, (0,mermaid_59c9be08.c)());
  if (!nodesMap[ID]) {
...
const db = {
  nodesMap,
  getConfig: () => (0,mermaid_59c9be08.c)().sankey,
  getNodes,
  getLinks,
  getGraph,
  addLink,
...
const draw = function(text, id, _version, diagObj) {
  const { securityLevel, sankey: conf } = (0,mermaid_59c9be08.c)();
  const defaultSankeyConfig = mermaid_59c9be08.K.sankey;
  let sandboxElement;
...
${prefix}${Math.round(value * 100) / 100}${suffix}`;
  ...
  (0,mermaid_59c9be08.o)(void 0, svg, 0, useMaxWidth);
};
const renderer = {
  draw
};
